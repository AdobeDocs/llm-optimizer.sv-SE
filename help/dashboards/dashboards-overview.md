        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./brand-presence.md" title="Kontrollpanel för varumärkesnärvaro" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/brand-presence-card.png" alt="Kontrollpanel för varumärkesnärvaro"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Spåra hur ert varumärke ser ut på olika sökplattformar, inklusive känslomässig analys och jämförande tester.</p>
                </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./agentic-traffic.md" title="Kontrollpanel för myndighetstrafik" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/agentic-traffic-card.png" alt="Kontrollpanel för myndighetstrafik"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./referral-traffic.md" title="Kontrollpanel för hänvisningstrafik" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/referral-traffic-card.png" alt="Kontrollpanel för hänvisningstrafik"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./opportunities.md" title="Kontrollpanel för affärsmöjligheter" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/opportunities-card.png" alt="Kontrollpanel för affärsmöjligheter"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./url-inspector.md" title="Kontrollpanel för URL-kontroll" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/url-inspector-card.png" alt="Kontrollpanel för URL-kontroll"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="./customer-configuration.md" title="Kontrollpanel för kundkonfiguration" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="../assets/overview/customer-configuration-card.png" alt="Kontrollpanel för kundkonfiguration"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
