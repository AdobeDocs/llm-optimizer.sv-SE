...
Om du använder ett mellanlagringsvärdnamn och en mellanlagrings-API-nyckel från LLM Optimizer lägger du till samma VCL-fragment i **mellanlagringen** med API-nyckeln **staging** . Verifiera sedan starttrafiken på mellanlagringsvärden:
